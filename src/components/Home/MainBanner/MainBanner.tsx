export default function InfoHome () {
  return (
    <div>
      <div className='w-80 container m-auto flex flex-col lg:flex-row lg:hidden sm:w-96 sm:m-auto mt-5 text-left sm:mt-14 p-2'>
        <div className='w-54 h-44 m-auto sm:w-full'>
